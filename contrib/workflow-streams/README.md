...
```typescript
import { WorkflowStream } from '@temporalio/workflow-streams/lib/workflow';
...
import { WorkflowStreamClient } from '@temporalio/workflow-streams/lib/client';
...
import { WorkflowStream, type WorkflowStreamState } from '@temporalio/workflow-streams/lib/workflow';
...
to happen _after_ pollers detach. Subscribers created via
