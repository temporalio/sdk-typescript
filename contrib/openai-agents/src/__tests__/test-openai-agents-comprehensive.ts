...
//   - Children are rendered in span-start order, so an `mcp_tools` pair from agent
//     init sorts after the `turn:*` span that opened just before it.
...
const EXPECTED_OTEL_TEST_1: string[][] = [
  [
    ...
    '              temporal:executeActivity:mockStatelessMcp-stateless-list-tools',
    '          mcp_tools',
    ...
    '                temporal:executeActivity:invokeModelActivity',
    '            function:searchDocs',
    '              temporal:startActivity:mockStatelessMcp-stateless-call-tool',
    '                temporal:executeActivity:mockStatelessMcp-stateless-call-tool',
    '          turn:4',
    '            generation',
    '              temporal:startActivity:invokeModelActivity',
    '                temporal:executeActivity:invokeModelActivity',
    ...
    '                    temporal:executeActivity:mockStatelessMcp-stateless-call-tool',
    '              mcp_tools',
    '                temporal:startActivity:mockStatelessMcpBOnly-stateless-list-tools',
    '                  temporal:executeActivity:mockStatelessMcpBOnly-stateless-list-tools',
    '              turn:10',
    '                generation',
    '                  temporal:startActivity:invokeModelActivity',
    '                    temporal:executeActivity:invokeModelActivity',
