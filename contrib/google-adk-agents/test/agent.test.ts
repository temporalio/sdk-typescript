...
describe('Native ADK Runner integration (E2E)', () => {
  it('runsLlmAgentThroughRunnerWithDurableModelCalls', async () => {
    ...
    expect(countScheduledActivities(events ?? [], 'invokeModel')).toBe(1);
  });
});
