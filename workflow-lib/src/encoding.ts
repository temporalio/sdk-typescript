...
export class TextDecoder {
  decode(inputArrayOrBuffer: Uint8Array | ArrayBuffer | SharedArrayBuffer) {
...
export class TextEncoder {
  public encode(inputString: string) {
    // 0xc0 => 0b11000000; 0xff => 0b11111111; 0xc0-0xff => 0b11xxxxxx
    // 0x80 => 0b10000000; 0xbf => 0b10111111; 0x80-0xbf => 0b10xxxxxx
    var encodedString = inputString === void 0 ? "" : ("" + inputString), len=encodedString.length|0;
    var result=new Uint8Array((len << 1) + 8|0), tmpResult;
    var i=0, pos=0, point=0, nextcode=0;
    var upgradededArraySize=!Uint8Array; // normal arrays are auto-expanding
  ...
  public encodeInto(inputString: string, u8Arr: Uint8Array) {
