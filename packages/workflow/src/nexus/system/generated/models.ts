  ...
  return {
    ...
    userMetadata:
      model.staticSummary == null && model.staticDetails == null
        ? undefined
        : {
            summary: model.staticSummary == null ? undefined : valueToPayload(model.staticSummary),
            details: model.staticDetails == null ? undefined : valueToPayload(model.staticDetails),
          },
