                  ...
                  <Encoded<coresdk.workflow_commands.IWorkflowCommand>>{
                    ...
                    upsertWorkflowSearchAttributes: command.upsertWorkflowSearchAttributes
                      ? {
                        ...
                        searchAttributes: noopEncodeSearchAttrs(command.upsertWorkflowSearchAttributes.searchAttributes),
                      }
                      : undefined,
                    ...
                    continueAsNewWorkflowExecution: command.continueAsNewWorkflowExecution
                      ? {
                        ...
                        searchAttributes: noopEncodeSearchAttrs(command.continueAsNewWorkflowExecution.searchAttributes),
                      }
                      : undefined,
                    startChildWorkflowExecution: command.startChildWorkflowExecution
                      ? {
                        ...
                        // don't encode searchAttributes
                        searchAttributes: noopEncodeSearchAttrs(command.startChildWorkflowExecution.searchAttributes),
                      }
                      : undefined,
