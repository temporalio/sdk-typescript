...
import {
  LONG_POLL_EXPIRATION_INTERVAL_MS,
  activities,
  asyncUpdate,
  canCompleteUpdateAfterWorkflowReturns,
  counterWorkflow,
  currentInfoUpdate,
  doneUpdate,
  earlyExecutedUpdate,
  getValueQuery,
  handlerHasBeenExecutedQuery,
  handlerRaisesException,
  incrementAndGetValueUpdate,
  incrementSignal,
  logUpdate,
  neverReturningUpdate,
  openGateSignal,
  setUpdateHandlerAndExit,
  stateMutatingUpdate,
  stringToStringUpdate,
  syncUpdate,
  update,
  updateReplayTestWorkflow,
  updateThatExecutesActivity,
  updateThatShouldFail,
  updateWithMutableArg,
  workflowThatWillBeCancelled,
  workflowWithArgAndUpdateArg,
  workflowWithCurrentUpdateInfo,
  workflowWithLogInUpdate,
  workflowWithMultiTaskUpdate,
  workflowWithMutatingValidator,
  workflowWithNeverReturningUpdate,
  workflowWithUpdateValidator,
  workflowWithUpdates,
} from './workflows/integration-update';
