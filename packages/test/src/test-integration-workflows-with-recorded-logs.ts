...
import {
  raiseErrorWorkflow,
  runUnfinishedHandlersWorkflowTerminationTypeWorkflow,
  unfinishedHandlersSignal,
  unfinishedHandlersSignal_ABANDON,
  unfinishedHandlersSignal_WARN_AND_ABANDON,
  unfinishedHandlersUpdate,
  unfinishedHandlersUpdate_ABANDON,
  unfinishedHandlersUpdate_WARN_AND_ABANDON,
  unfinishedHandlersWorkflow,
  unfinishedHandlersWorkflowTerminationTypeSignal,
  unfinishedHandlersWorkflowTerminationTypeUpdate,
} from './workflows/integration-workflows-with-recorded-logs';
  ...
  async runWorkflowAndGetWarning(): Promise<boolean> {
    ...
    switch (this.handlerType) {
      case 'update':
        ...
        await waitUntil(() => workflowUpdateExists(w, updateId), 20_000);
        break;
      case 'signal':
